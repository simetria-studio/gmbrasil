                                    ...
                                    <ul class="navbar-list">
                                        <li>
                                            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                                <img src="https://ui-avatars.com/api/?size=512&amp;background=5B4699&amp;color=fff&amp;name={{ auth()->user()->name }}"
                                                ...
                                                <div class="iq-card shadow-none m-0">
                                                    <div class="iq-card-body p-0 ">
                                                        <div class="bg-primary p-3">
                                                            <h5 class="mb-0 text-white line-height">Olá,
                                                                {{ auth()->user()->name }}</h5>
                        ...
                        <div class="iq-menu-horizontal-tab">
                            <nav class="iq-sidebar-menu">
                                <ul id="iq-sidebar-toggle" class="iq-menu d-flex justify-content-left">
                                    <li>
                                        <a href="{{ route('admin.index') }}" class="iq-waves-effect collapsed"
                                            aria-expanded="false"><i class="ri-home-4-line"></i><span>Home</span></a>
                                    </li>
                                    <li class="active">
                                        <a href="#menu-design" class="iq-waves-effect collapsed" data-toggle="collapse"
                                            aria-expanded="true"><i class="ri-menu-3-line"></i><span>Gerenciamento de
                                                Usuários</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                        <ul id="menu-design" class="iq-submenu collapse"
                                            data-parent="#iq-sidebar-toggle">
                                            <li><a href="{{ route('admin.users') }}"><i
                                                        class="ri-git-commit-line"></i>Usuários</a></li>
                                    ...
                                    <li class="active">
                                        <a href="#menu-design" class="iq-waves-effect collapsed" data-toggle="collapse"
                                            aria-expanded="true"><i class="ri-menu-3-line"></i><span>Gerenciamento de
                                                Produtos</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                        <ul id="menu-design" class="iq-submenu collapse"
                                            data-parent="#iq-sidebar-toggle">
                                            <li><a href="{{ route('admin.categoria') }}"><i
                                                        class="ri-git-commit-line"></i>Categorias</a></li>
                                            <li><a href="{{ route('admin.produtos') }}"><i
                                                        class="ri-git-commit-line"></i>Produtos</a></li>
                                        </ul>
