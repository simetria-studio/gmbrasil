            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12 center-search">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('assets/img/logo-dourada-nova.png') }}"
                                    alt="logo"></a>
                        </div>
                        <!--/ End Logo -->
                        <!-- Search Form -->
                    ...
                    <div class="col-lg-2 col-md-3 col-12 center-search">
                        <div class="right-bar">
                            ...
                            <div class="sinlge-bar">
                                <a href="{{ route('home') }}" class="single-icon"><i class="fa fa-user-circle-o"
                                        aria-hidden="true"></i></a>
                            </div>
                            <div class="sinlge-bar shopping">
                                <a href="#" class="single-icon"><i class="ti-bag"></i> <span
                                        class="total-count">{{ \Cart::getTotalQuantity() }}</span></a>
                                <!-- Shopping Item -->
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span class="count">{{ \Cart::getTotalQuantity() }} Items</span>
                                        <a href="#">Ver Carrinho</a>
                                    </div>
                                    <ul class="shopping-list">
                                        @foreach (\Cart::getContent() as $cart)
                                            <li>
                                                <a href="#" data-id="{{ $cart->id }}" class="remove" title="Remove this item"><i
                                                        class="fa fa-remove"></i></a>
                                                <a class="cart-img" href="#"><img
                                                        src="{{ asset('storage/' . $cart->attributes->image)}}" alt="#"></a>
                                                <h4><a href="#">{{ $cart->name }}</a></h4>
                                                <p class="quantity">{{ $cart->quantity }}x - <span class="amount">R$
                                        ...
                                        <div class="nav-inner">
                                            <ul class="nav main-menu menu navbar-nav">
                                                ...
                                                @forelse (getCategories() as $category)
                                                    <li>
                                                        <a class="nav-link"
                                                            href="{{ asset('categoria/' . $category->slug) }}">{{ $category->name }}
                                                            @if ($category->subCategories->count() > 0)<i class="ti-angle-down"></i>@endif</a>
                                                        ...
                                                        @if ($category->subCategories->count() > 0)
                                                            <ul class="dropdown">
                                                                @forelse ($category->subCategories as $subCategory)
                                                                    <li>
                                                                        <a class="nav-link"
                                                                            href="{{ asset('categoria/' . $subCategory->slug) }}">{{ $subCategory->name }}</a>
                                                                    </li>
                                                                @empty
                                                                @endforelse
                                                            </ul>
                    ...
                    <div class="inner">
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="left">
                                    <p>Copyright © {{ date('Y') }} <a href="cubeti.dev.br" target="_blank">CUBETI</a> -
