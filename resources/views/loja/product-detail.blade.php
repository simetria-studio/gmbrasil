                                    ...
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="iq-product-action my-2">
                                                <button type="button"
                                                    class="btn btn-primary iq-waves-effect text-uppercase btn-sm"
                                                    tabindex="0">
                                                    <i class="ri-shopping-cart-2-line m-0"></i>
                                                </button>
                                                <button type="button" class="btn btn-primary ml-2 btn-sm" tabindex="0">
                                                    <i class="ri-heart-line m-0"></i>
                                                </button>
                                                <p class="font-size-16 font-weight-bold float-right">$999.99</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">Sed dictum orci vel</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">neque venenatis</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">Proin at diam sit amet</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">augue rhoncus ornare</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">Nulla venenatis mi sed</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">Etiam interdum nisi et</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
                            ...
                            <li class="product_item col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="iq-card">
                                    <div class="product-miniature">
                                        ...
                                        <div class="product-description">
                                            <h4><a href="#">dignissim orci quis</a></h4>
                                            <p class="mb-0">Proin sed risus mattis</p>
